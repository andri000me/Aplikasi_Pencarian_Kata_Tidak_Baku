...
<html lang="en">
  ...
  <body>
    <div class="container">
      <h3 class="display-4 text-center">*Pencarian Kata Tidak Baku*</h3>
      <div class="row">
		...
		<div class="col-12">
		  ...
		  <small class="text-danger font-weight-bold">* Klik tombol "Unggah Dokumen untuk memilih dokumen format .docx *</small><br>
		  <small class="text-danger font-weight-bold">* Klik tombol "Proses Dokumen untuk melakukan proses selanjutnya *</small>
		</div>
      </div>
    </div>
